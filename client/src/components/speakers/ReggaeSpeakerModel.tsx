...
type Props = { modelId: SpeakerModelId; kind: SpeakerKind; activity: number; bandActivity?: SpeakerBandActivity; selected?: boolean; glowStrength?: number };
