 ...
 * LOW → MID → HIGH is red → yellow → green. Only physical drivers and horn/opening interiors emit.
 * Geometry and passive detail materials are module-level; every mounted Speaker owns four stable materials.
 */
...
const typeGlowGain: Record<SpeakerKind, { horn: number; driver: number }> = {
  sub: { horn: .82, driver: .22 }, woofer: { horn: .78, driver: .35 }, full: { horn: .78, driver: .92 }, mid: { horn: .74, driver: .78 }, high: { horn: 1.05, driver: .96 },
};
