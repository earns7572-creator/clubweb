...
export function findStackCandidate({ dragged, point, speakers, previousParentId, minimumTargetMeters = 0 }: { dragged: ClubSpeaker; point: StackPoint; speakers: ClubSpeaker[]; previousParentId?: string | null; minimumTargetMeters?: number }) {
