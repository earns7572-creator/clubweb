...
const GLB_ASSET_URLS: Record<string, string> = {
  // Modern and Reggae intentionally stay on their family-specific procedural visuals.
...
export const SPEAKER_MODELS: Record<SpeakerModelId, SpeakerModelDefinition> = {
  ...
  "modern-full": model("modern-full", "modern", "full", "Full Range", "Full", [.78, 1.38, .58], [{ type: "allpass", frequency: 1000, q: .3 }], "modern/point-source.glb"),
