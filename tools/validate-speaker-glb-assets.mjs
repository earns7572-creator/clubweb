...
async function validate(spec) {
  ...
  const allowedCabinets = ["freeparty-wbin","freeparty-kick-horn"].includes(spec.id) ? new Set(["#242423"]) : spec.family === "hifi" ? new Set(["#76583c"]) : spec.family === "freeparty" ? new Set(["#64696d"]) : new Set(["#70767b"]);
