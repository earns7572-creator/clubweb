...
assert.equal(SPEAKER_MODELS["modern-full"].visual.plannedGlbPath, "modern/point-source.glb", "Modern Full Range returns to the CLUB-family procedural contract");
