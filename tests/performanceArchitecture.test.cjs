...
assert.match(audio, /panner\.distanceModel = "inverse"; panner\.refDistance = 1\.2; panner\.maxDistance = 12; panner\.rolloffFactor = \.85; panner\.coneInnerAngle = 90; panner\.coneOuterAngle = 180; panner\.coneOuterGain = \.35/);
...
assert.match(top, /const handleY = height \/ 2 \+ \.22/);
assert.match(top, /circleGeometry args=\{\[\.46, 32\]\}/);
